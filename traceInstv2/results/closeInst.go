...
func baz(x chan struct {
	...
	tracer.ReadAcc(x, "C:\\Users\\stka0001\\Github\\gopherlyzer-GoScout\\Tests\\close.go:10")
...
func main() {
	...
	tracer.ReadAcc(x, "C:\\Users\\stka0001\\Github\\gopherlyzer-GoScout\\Tests\\close.go:16")
	bar(x)
}
